         ...
         dark:text-white duration-200 relative z-40'>
            <div className='py-5'>
                ...
                justify-between items-center">
                    ...
                    text-gray-500 font-semibold text-md items-center'>
                            ...
                            <div className='relative group hidden xl:block'>
                                <a className='duration-200 hover:text-black 
                            ...
                            ' > Quik Links <span>
                                ...
                                duration-200 z-[9999]
                                '>
                                    <a className='duration-200 transition-all
                                    hover:bg-primary/20 p-3 rounded-md' href="#"> Trending Products </a>
                                    <a className='duration-200 transition-all
                                    hover:bg-primary/20 p-3 rounded-md' href="#"> Best Selling </a>
                                    <a className='duration-200 transition-all
                                    hover:bg-primary/20 p-3 rounded-md' href="#"> Top Rated </a>
                                </ul>
                            </div>
                    ...
                    <div className='flex items-center gap-5'>
                        <div className='hidden sm:flex relative group items-center'>
                            ...
                            <CiSearch className='text-2xl text-gray-600 
                             ...
                             duration-200 cursor-pointer hover:text-primary
